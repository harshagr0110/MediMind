    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-blue-100 rounded-xl p-6 shadow text-center">
          <div className="text-2xl font-bold text-blue-700 mb-2">Doctors</div>
          <div className="text-4xl font-extrabold text-blue-900">{loading ? <Spinner /> : stats.doctors}</div>
        </div>
        <div className="bg-blue-100 rounded-xl p-6 shadow text-center">
      ...
      <div className="bg-white rounded-xl shadow p-8 mt-8">
        <h2 className="text-xl font-bold text-blue-700 mb-4">Welcome to the MediMind Admin Panel!</h2>
        <p className="text-gray-700">Manage doctors, patients, appointments, and articles from this dashboard.</p>
      </div>
    </div>
  );
};
